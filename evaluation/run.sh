...
python combine.py -hr "data/result/svm_eta"$eta"_first" -nr "nsvm_results/svm_eta"$eta"_first" -n $n -eta $eta -out $out
echo "combining ranks ... done"

python plotter.py -res "results/"$pass"pass_eta"$eta"_combined_arrr.csv" -out "plots/"$pass"pass_eta"$eta"_combined_arrr.png"
python plotter.py -res "results/"$pass"pass_eta"$eta"_combined_ndcg_10.csv" -out "plots/"$pass"pass_eta"$eta"_combined_ndcg_10.png"
