...
#  file3="prop_svm.$pass""pass.see$k.eta$eta"
  ...
  python3 svm.py "ninety_nine_percent_set$set.train.txt" "prediction.txt" "set$set.test.txt" $file1 $file2 $pass $k $eta $run_num -1 0 &
  wait
  ...
  do
      ...
      python3 svm.py "ninety_nine_percent_set$set.train.txt" "prediction.txt" "set$set.valid.txt" "set$set.test.txt" $file1 $file2 $pass $i $eta $run_num -1 0 &
      wait
